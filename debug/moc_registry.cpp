...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Registry_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "Registry\0on_pushButton_clicked\0\0"
};
...
const QMetaObject Registry::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Registry.data,
      qt_meta_data_Registry,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Registry.stringdata))
